...
export default function Navbar() {
  ...
  return (
    <>
        <nav className="fixed w-full top-0 bg-white drop-shadow shadow-md p-3 h-[60px] lg:h-[80px]">
            ...
            <div className="hidden lg:flex h-full items-center justify-around">
                <Image src="/assets/images/myntra.webp" alt={""} width={56} height={56} className="w-auto h-auto"/>
